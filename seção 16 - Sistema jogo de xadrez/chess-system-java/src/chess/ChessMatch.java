...
public class ChessMatch {
    ...
    private Piece makeMove(Position source, Position target) {
        ChessPiece p = (ChessPiece)board.removePiece(source); // remove the origin piece
        p.increaseMoveCount();
    ...
    private void undoMove(Position source, Position target, Piece capturedPiece) {
		ChessPiece p = (ChessPiece)board.removePiece(target); // remove the target piece
        p.decreaseMoveCount();
    ...
    // locates a king of a certain color
    ...
    // tests all possible moves of all opposing pieces to see if any possible moves of theirs land on the king's square
    ...
    // test if the king is in check and there is no possible move by any piece of its color that would take it out of check
