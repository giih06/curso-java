...
--
-- Name: tb_order_item_items; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.tb_order_item_items (
    order_item_order_id bigint NOT NULL,
    order_item_product_id bigint NOT NULL,
    items_order_id bigint NOT NULL,
    items_product_id bigint NOT NULL
);
...
--
-- Name: tb_order_item_items tb_order_item_items_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order_item_items
    ADD CONSTRAINT tb_order_item_items_pkey PRIMARY KEY (order_item_order_id, order_item_product_id, items_order_id, items_product_id);
...
--
-- Name: tb_order_item_items uk_jbnhpno5f8ammc899j8ou4tbd; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order_item_items
    ADD CONSTRAINT uk_jbnhpno5f8ammc899j8ou4tbd UNIQUE (items_order_id, items_product_id);
...
--
-- Name: tb_order_item_items fkp5pudky3bn9plsokwtv8y5at9; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order_item_items
    ADD CONSTRAINT fkp5pudky3bn9plsokwtv8y5at9 FOREIGN KEY (order_item_order_id, order_item_product_id) REFERENCES public.tb_order_item(order_id, product_id);


--
-- Name: tb_order_item_items fkq8ahtmx671h1mxy5opyn5xx03; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.tb_order_item_items
    ADD CONSTRAINT fkq8ahtmx671h1mxy5opyn5xx03 FOREIGN KEY (items_order_id, items_product_id) REFERENCES public.tb_order_item(order_id, product_id);
